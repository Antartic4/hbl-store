            ...
            >
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  autoFocus
                  {...register('name', {
                    required: 'Porfavor introduzca nombre',
                  })}
                />
                {errors.name && (
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  id="price"
                  {...register('price', {
                    required: 'Porfavor introduzca precio',
                  })}
                />
                {errors.price && (
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  id="image"
                  {...register('image', {
                    required: 'Porfavor introduzca imagen',
                  })}
                />
                {errors.image && (
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  id="category"
                  {...register('category', {
                    required: 'Porfavor introduzca categoria',
                  })}
                />
                {errors.category && (
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  id="brand"
                  {...register('brand', {
                    required: 'Porfavor introduzca marca',
                  })}
                />
                {errors.brand && (
              ...
              <div className="mb-4">
                <label htmlFor="countInStock">Cantidad Disp</label>
                <input
                  type="text"
                  className="w-full"
                  id="countInStock"
                  {...register('countInStock', {
                    required: 'Porfavor introduzca cantidad disponible',
                  })}
                />
                {errors.countInStock && (
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  {...register('description', {
                    required: 'Porfavor introduzca descripcion',
                  })}
                />
                {errors.description && (
                  <div className="text-red-500">
